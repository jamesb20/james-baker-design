...
export default function Project({
  ...
  return (
    <Link href={`/project/${slug}?fileLen=${picLen}`}>
      <motion.div
        ref={ref}
        style={{
          scale: scaleProgess,
      ...
      overflow-hidden sm:pr-8 relative sm:h-[20rem] hover:bg-gray-200 transition pl-8
       dark:text-white dark:bg-white/10 dark:hover:bg-white/20">

          <div className="pt-4 pb-7 px-5 sm:pl-10 sm:pr-2 sm:pt-10 sm:max-w-[50%] flex flex-col h-full ml-[18rem]">
